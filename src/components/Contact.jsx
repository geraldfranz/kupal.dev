  ...
  return (
    <section id="contact" className={`py-20 px-4 ${sectionBg}`}>
      <div className="max-w-4xl mx-auto text-center">
        <h2
          className={`font-display font-bold text-4xl sm:text-5xl ${headingColor} mb-6`}
        >
          Let's Create Together
        </h2>
        <p className={`font-sans ${bodyColor} text-lg mb-12`}>
          Have an idea? Let's bring it to life. Reach out to us and let's start
          a conversation.
        </p>
        ...
        >
          hello@kupal.dev
          <div className="h-1 w-36 mx-auto bg-linear-to-r from-transparent via-accent-red to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-300 mt-3" />
        </a>
